...
public class Candy {
    ...
    @OneToOne(cascade = {CascadeType.ALL}) //this ONE shop has this ONE candy
    @JoinColumn(name = "c_shop") //name of this shop
    private Shop shop; //array of shops for Many to Many relationship
